...
class ApplyWriteRecyclerViewAdapter(var items : ArrayList<Empty>)  : RecyclerView.Adapter<ApplyWriteViewHolder>(){
    ...
    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): ApplyWriteViewHolder {
        ...
        return ApplyWriteViewHolder(view,parent.context)
    }
